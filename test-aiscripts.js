...
const { streamingParse } = require('./out/provider/streaming-parser');
const { BlockStatement, VariableDeclaration } = require('./out/vjass/ast');
const { extractLeadingComments } = require('./out/provider/comment-parser');
