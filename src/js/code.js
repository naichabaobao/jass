...
const item = {
  ...
  "stpg": { code: "", name: "时钟企鹅", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "red0": { code: "", name: "守护指环+1", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "oflg": { code: "", name: "兽族旗帜", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "frgd": { code: "", name: "霜冻守卫", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "shdt": { code: "", name: "死亡领主护盾", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "crdt": { code: "", name: "死亡领主皇冠", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "pspd": { code: "", name: "速度药水", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "iwbr": { code: "", name: "铁树枝干", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "ccmd": { code: "", name: "统治权杖", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "tbar": { code: "", name: "微型兵营", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "tlum": { code: "", name: "微型伐木场", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "tbak": { code: "", name: "微型国王祭坛", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "tfar": { code: "", name: "微型农场", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "tbsm": { code: "", name: "微型铁匠铺", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sfog": { code: "", name: "乌云号角", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "vddl": { code: "", name: "巫毒玩偶", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "tmsc": { code: "", name: "牺牲之书", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "horl": { code: "", name: "稀有神器", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "axas": { code: "", name: "先祖权杖", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "gemt": { code: "", name: "显形宝石", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "rej5": { code: "", name: "小型恢复卷轴", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "rej2": { code: "", name: "小型恢复药水", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "rej1": { code: "", name: "小型恢复药水", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "scul": { code: "", name: "邪恶军团卷轴", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "musf": { code: "", name: "心灵权杖", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "fgun": { code: "", name: "信号枪", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "lnrn": { code: "", name: "雄狮之戒", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "bfhr": { code: "", name: "血羽之心", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "schl": { code: "", name: "医疗权杖", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor1": { code: "", name: "影子之球+1", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sora": { code: "", name: "影子之球+10", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor2": { code: "", name: "影子之球+2", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor3": { code: "", name: "影子之球+3", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor4": { code: "", name: "影子之球+4", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor5": { code: "", name: "影子之球+5", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor6": { code: "", name: "影子之球+6", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor7": { code: "", name: "影子之球+7", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor8": { code: "", name: "影子之球+8", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sor9": { code: "", name: "影子之球+9", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "rnsp": { code: "", name: "优越之戒", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "anfg": { code: "", name: "远古雕像", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "klmm": { code: "", name: "远古战斧", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "btst": { code: "", name: "战斗标准", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "stwa": { code: "", name: "战斧", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "hbth": { code: "", name: "战舰之舵", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "amrc": { code: "", name: "召唤护身符", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "sprn": { code: "", name: "蜘蛛戒指", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
  "srbd": { code: "", name: "灼热之刀", tip: "", kind: Kind.Item, race: Race.Special, type: Type.Item },
}
