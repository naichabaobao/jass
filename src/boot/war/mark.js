...
exports.MarkCodes = exports.typeToString = exports.raceToString = exports.kindToString = exports.Type = exports.Race = exports.Kind = exports.MarkCode = void 0;
var Kind;
(function (Kind) {
    Kind[Kind["Unit"] = 0] = "Unit";
    Kind[Kind["Item"] = 16] = "Item";
    Kind[Kind["Destructible"] = 32] = "Destructible";
    Kind[Kind["Ornament"] = 48] = "Ornament";
    Kind[Kind["Ability"] = 64] = "Ability";
    Kind[Kind["Buff"] = 80] = "Buff";
    Kind[Kind["Technology"] = 96] = "Technology";
})(Kind || (Kind = {}));
exports.Kind = Kind;
...
(function (Race) {
    ...
    Race[Race["Orc"] = 16] = "Orc";
    Race[Race["NightElf"] = 32] = "NightElf";
    Race[Race["Undead"] = 48] = "Undead";
    Race[Race["Naga"] = 64] = "Naga";
    Race[Race["NeutralHostile"] = 80] = "NeutralHostile";
    Race[Race["NeutralPassive"] = 96] = "NeutralPassive";
    Race[Race["Special"] = 112] = "Special";
})(Race || (Race = {}));
exports.Race = Race;
var raceToString = function (race) {
    switch (race) {
        case Race.Human:
            return "人族";
        case Race.Orc:
...
var Type;
(function (Type) {
    Type[Type["Unit"] = 0] = "Unit";
    Type[Type["Architecture"] = 16] = "Architecture";
    Type[Type["Hero"] = 32] = "Hero";
    Type[Type["Special"] = 48] = "Special";
    Type[Type["Item"] = 64] = "Item";
})(Type || (Type = {}));
exports.Type = Type;
...
var unitHuman = {
    ...
    "Hssa": { code: "Hssa", name: "安纳斯特里亚·逐日者(1.32)", tip: "", kind: Kind.Unit, race: Race.Human, type: Type.Special },
    "Hddt": { code: "Hddt", name: "萨洛瑞安·寻晨者(1.32)", tip: "", kind: Kind.Unit, race: Race.Human, type: Type.Special },
    "Haah": { code: "Haah", name: "求知者凯伦(1.32)", tip: "", kind: Kind.Unit, race: Race.Human, type: Type.Special },
    "Hjnd": { code: "Hjnd", name: "婕娜拉·晓春(1.32)", tip: "", kind: Kind.Unit, race: Race.Human, type: Type.Special },
};
var unitOrc = {
...
var abilityHuman = {
    ...
    "Ahpe": { code: "Ahpe", name: "凤凰(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Human, type: Type.Hero },
    "Ahan": { code: "Ahan", name: "坐骑作战训练(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Human, type: Type.Hero },
    "Ahlh": { code: "Ahlh", name: "改良伐木技术(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Human, type: Type.Hero },
    "Ahri": { code: "Ahri", name: "长管火枪(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Human, type: Type.Hero },
    "Ahsb": { code: "Ahpe", name: "裂甲之刃(1.30)", tip: "对具有中型护甲的敌方目标造成的伤害提高<Ahsb,DataB1,%>%。", kind: Kind.Ability, race: Race.Human, type: Type.Hero },
};
var abilityOrc = {
    ...
    "Aorb": { code: "Aorb", name: "加强型防御(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Orc, type: Type.Hero },
    "Aosp": { code: "Aosp", name: "尖刺障碍(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Orc, type: Type.Hero },
    "Aotr": { code: "Aotr", name: "巨魔再生(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Orc, type: Type.Hero },
    "Aobk": { code: "Aobk", name: "狂战士升级(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Orc, type: Type.Hero },
    "Aobs": { code: "Aobs", name: "野蛮之力(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Orc, type: Type.Hero },
};
var abilityNightElf = {
    ...
    "Aeib": { code: "Aeib", name: "强弓(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.NightElf, type: Type.Hero },
    "Aews": { code: "Aews", name: "月井之春(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.NightElf, type: Type.Hero },
    "Aemk": { code: "Aemk", name: "箭术(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.NightElf, type: Type.Hero },
};
var abilityUndead = {
    ...
    "Aatp": { code: "Aatp", name: "优先攻击(石像鬼)(1.32.9)", tip: "未收到其他命令时，优先攻击敌方飞行单位。", kind: Kind.Ability, race: Race.Undead, type: Type.Hero },
    "Aap5": { code: "Aap5", name: "疾病云雾(亡者再临)(1.33)", tip: "用疾病之云感染周围的敌方生命单位，每秒对其造成<Aap5,DataB1>点伤害。|n持续<Aap5,DataA1>秒。", kind: Kind.Ability, race: Race.Undead, type: Type.Hero },
    "Augf": { code: "Augf", name: "食尸鬼狂暴(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Undead, type: Type.Hero },
    "Ausm": { code: "Ausm", name: "骷髅精通(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Undead, type: Type.Hero },
    "Afrc": { code: "Afrc", name: "冰霜攻击(新的,具有图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Undead, type: Type.Hero },
    "Augh": { code: "Augh", name: "影魔(图标)(1.32)", tip: "", kind: Kind.Ability, race: Race.Undead, type: Type.Hero },
};
var abilityNeutralHostile = {
...
var abilityItem = {
    "AIg2": { code: "AIg2", name: "仪式匕首(恢复)(1.30)", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Hero },
    "AIdg": { code: "AIdg", name: "仪式匕首(瞬发治疗)(1.30)", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Hero },
...
var MarkCode = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, unitHuman), unitOrc), unitNightElf), unitUndead), unitNaga), unitNeutralHostile), unitNeutralPassive), abilityHuman), abilityOrc), abilityNightElf), abilityUndead), abilityNeutralHostile), abilityNeutralPassive), abilityItem), item), buffHuman);
exports.MarkCode = MarkCode;
var MarkCodes = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read(Object.values(unitHuman)), false), __read(Object.values(unitOrc)), false), __read(Object.values(unitNightElf)), false), __read(Object.values(unitUndead)), false), __read(Object.values(unitNaga)), false), __read(Object.values(unitNeutralHostile)), false), __read(Object.values(unitNeutralPassive)), false), __read(Object.values(abilityHuman)), false), __read(Object.values(abilityOrc)), false), __read(Object.values(abilityNightElf)), false), __read(Object.values(abilityUndead)), false), __read(Object.values(abilityNeutralHostile)), false), __read(Object.values(abilityNeutralPassive)), false), __read(Object.values(abilityItem)), false), __read(Object.values(item)), false), __read(Object.values(buffHuman)), false);
exports.MarkCodes = MarkCodes;
