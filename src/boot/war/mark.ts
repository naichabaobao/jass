...
const unitHuman = {
  ...
  const abilityHuman = {
    ...
    "Adts": { code: "Adts", name: "魔法岗哨人族的防御塔", tip: "显示周围的隐形单位。", kind: Kind.Ability, race: Race.Human, type: Type.Unit },
    "Afbk": { code: "Afbk", name: "魔法回应(魔法破坏者)", tip: "魔法破坏者每次攻击消耗目标<Afbk,DataA1>点魔法值。魔法燃烧后将会对攻击对象造成伤害。", kind: Kind.Ability, race: Race.Human, type: Type.Unit },
    "Afbt": { code: "Afbt", name: "魔法回应(神秘之塔)", tip: "塔的每次攻击消耗目标<Afbt,DataA1>点魔法值，同时还对于目标造成相同数值的伤害。|n|n这种塔的攻击对于召唤出来的单位还能造成<Afbt,DataE1>点的附加伤害。", kind: Kind.Ability, race: Race.Human, type: Type.Unit },
  ...
  const abilityOrc = {
    ...
    "Apak": { code: "Apak", name: "行囊技能", tip: "让该单位能为英雄携带物品。物品在处于该单位物品栏里的时候不能被使用。", kind: Kind.Ability, race: Race.Orc, type: Type.Unit },
    ...
    "Abun": { code: "Abun", name: "货物保持(兽 族地洞)", tip: "吞噬货物使单位能够容纳别的单位，可以配合装载类技能和卸载类技能的使用。该技能能使单位失去攻击能力直到装载其他单位", kind: Kind.Ability, race: Race.Orc, type: Type.Unit },
    ...
    "Adch": { code: "Adch", name: "消魔(年长的)", tip: "驱散目标区域单位身上所有的魔法效果。|n|cffffcc00对召唤出来的单位造成<Adch,DataB1>点的伤害。|r", kind: Kind.Ability, race: Race.Orc, type: Type.Unit },
    "Astd": { code: "Astd", name: "卸载苦工", tip: "使得地洞内的苦工重新回到自己的工作岗位上。", kind: Kind.Ability, race: Race.Orc, type: Type.Unit },
    "Arep": { code: "Arep", name: "修理", tip: "修理建筑物和机械单位，需要消耗资源。", kind: Kind.Ability, race: Race.Orc, type: Type.Unit },
    ...
    "Sbtl": { code: "Sbtl", name: "战备状态(混乱的兽族地洞)", tip: "使得附近的苦工跑入地洞从而对来犯的敌人进行反击。", kind: Kind.Ability, race: Race.Orc, type: Type.Unit },
    "Abtl": { code: "Abtl", name: "战斗位置", tip: "使得附近的苦工跑入地洞从而对来犯的敌人进行反击。", kind: Kind.Ability, race: Race.Orc, type: Type.Unit },
  ...
  const abilityNightElf = {
    ...
    "Acoh": { code: "Acoh", name: "搭载弓箭手(年长的)", tip: "搭载一个弓箭手使其能在空中对敌人进行攻击。|n|n|cffffcc00能攻击地面和空中单位。|r", kind: Kind.Ability, race: Race.NightElf, type: Type.Unit },
    ...
    "Aren": { code: "Aren", name: "更新", tip: "让友方的暗夜精灵建筑物、联盟建筑物与友方的机械单位焕然一新。", kind: Kind.Ability, race: Race.NightElf, type: Type.Unit },
    ...
    "Acoa": { code: "Acoa", name: "骑乘角鹰兽(年长的)", tip: "骑在角鹰兽身上以后，弓箭手可以从空中进行攻击。|n|n|cffffcc00能攻击地面和空中单位。|r", kind: Kind.Ability, race: Race.NightElf, type: Type.Unit },
    ...
    "Adec": { code: "Adec", name: "卸载", tip: "将弓箭手从角鹰兽身上卸载下来。", kind: Kind.Ability, race: Race.NightElf, type: Type.Unit },
  ...
  const abilityUndead = {
    ...
    "Scri": { code: "Scri", name: "残废(巫师)", tip: "减慢目标单位<Acri,DataA1,%>%的移动速度和<Acri,DataB1,%>%攻击速度，并减弱其<Acri,DataC1,%>%的攻击力。|n持续<Acri,Dur1>秒。", kind: Kind.Ability, race: Race.Undead, type: Type.Unit },
    ...
    "Amel": { code: "Amel", name: "得到尸体", tip: "捡起附近的一个尸体来做备用。", kind: Kind.Ability, race: Race.Undead, type: Type.Unit },
    ...
    "Abgs": { code: "Abgs", name: "小型荒芜之地薆延", tip: "只在获得技能时进行一次地表改变", kind: Kind.Ability, race: Race.Undead, type: Type.Unit },
  ...
  const abilityNeutralHostile = {
    ...
    "Ahr2": { code: "Ahr2", name: "采集(阿克蒙德的食尸鬼在采伐木材)", tip: "从树木上采集木材资源。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    "Ahr3": { code: "Ahr3", name: "采集(地精正在采集木材)", tip: "从树木上采集木材资源。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    "Awh2": { code: "Awh2", name: "采集(小精灵可以采集黄金和木材一远古灵魂)", tip: "你可以从缠绕金矿中采集黄金，从树木中采集木材。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "Asod": { code: "Asod", name: "产卵之骨(黑暗之箭)", tip: "", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "ANb2": { code: "ANb2", name: "大锤(中立敌对3)", tip: "使得有<ANb2,DataA1>%的概率让一次进攻能施放出<ANb2,DataC1>点的额外伤害，并能在<ANb2,Dur1>秒内让对手处于昏晕状态。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    "Aspy": { code: "Aspy", name: "诞生刺蛇", tip: "", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    "Aspt": { code: "Aspt", name: "诞生刺蛇幼虫", tip: "", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "Afbb": { code: "Afbb", name: "反馈", tip: "灵兽每次攻击抵消<Afbb,DataA1>点魔力。这些魔力值燃烧，对被攻击单位造成伤害。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "Aap4": { code: "Aap4", name: "疾病云雾(中立敌对无伤害)", tip: "用疾病来感染周围的敌人。疾病云雾每秒能对敌人造成<Aap3,DataB1>点的伤害。|n持续<Aap3,DataA1>秒。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "Awfb": { code: "Awfb", name: "霹雳闪电(巫师)", tip: "能将敌人击晕。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "AAns": { code: "AAns", name: "收费", tip: "向某个玩家收取固定数额的金子和木材。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "Assp": { code: "Assp", name: "小蜘蛛(中立敌对)", tip: "", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    "Aspd": { code: "Aspd", name: "小蜘蛛(中立敌对)", tip: "", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "Suhf": { code: "Suhf", name: "邪恶狂热(巫师)", tip: "增加目标单位<Suhf,DataA1,%>%的攻击速度，但是每秒也会消耗目标<Suhf,DataB1>点的生命值。|n持续<Suhf,Dur1>秒。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "ACs9": { code: "ACs9", name: "野兽幽魂(中立敌对野猪)", tip: "能召唤出<ACs9,DataB1>个野猪幽灵来。|n持续<ACs9,Dur1>秒。|n|n|cffffcc00能攻击地面单位。|r", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Unit },
    ...
    "SNin": { code: "SNin", name: "地狱火(提科恩迪斯)", tip: "召唤出一个地狱火恶魔从天而降，对一定区域内敌方的地面单位造成<SNin,DataA1>点的伤害并使其在<SNin,Dur1>秒内处于昏晕状态。地狱火恶魔持续<SNin,DataB1>秒。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
    ...
    "ANdp": { code: "ANdp", name: "黑暗之门(啊克蒙德)", tip: "开启一扇黑暗之门，从中会走出各种各样的恶魔来为阿克蒙德效力。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
    "ANdc": { code: "ANdc", name: "黑暗转换(马哥尼斯)", tip: "让一个村民陷入睡眠，并将其变成僵尸。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
    "SNdc": { code: "SNdc", name: "黑暗转换(马哥尼斯，快的)", tip: "让一个村民陷入睡眠，并将其变成僵尸。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
    ...
    "ANrc": { code: "ANrc", name: "混乱之雨(啊克蒙德)", tip: "召唤出几个地狱火恶魔从天而降。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
    "ANr3": { code: "ANr3", name: "混乱之雨(巴那泽尔)", tip: "召唤出几个地狱火恶魔从天而降。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
    ...
    "ANfd": { code: "ANfd", name: "死亡之指(啊克蒙德)", tip: "能立刻杀死某个生物或者摧毁某个建筑物。完全地摧毁它。", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
    ...
    "ANcl": { code: "ANcl", name: "通魔", tip: "可作为大多数主动技能的模板，可以被魔法护盾护身符抵挡", kind: Kind.Ability, race: Race.NeutralHostile, type: Type.Hero },
  ...
  const abilitySpecial = {
    ...
    "Aion": { code: "Aion", name: "单位物品栏(兽 族)", tip: "让该单位能为英雄携带物品。物品在处于该单位物品栏里的时候不能被使用。", kind: Kind.Ability, race: Race.Special, type: Type.Unit },
    ...
    "Amnz": { code: "Amnz", name: "范围性攻击伤害(大矿)", tip: "造成法术攻击，普通伤害", kind: Kind.Ability, race: Race.Special, type: Type.Unit },
    ...
    "Apmf": { code: "Apmf", name: "凤凰火焰(行单位)", tip: "对周围敌方的飞行单位造成每秒<Apmf,DataA1>点的伤害。", kind: Kind.Ability, race: Race.Special, type: Type.Unit },
    ...
    "Adro": { code: "Adro", name: "卸载(地精飞艇) ", tip: "在指定区域卸载全部单位。", kind: Kind.Ability, race: Race.Special, type: Type.Unit },
    "Sdro": { code: "Sdro", name: "卸载(海上运输船)", tip: "在指定区域卸载全部单位。", kind: Kind.Ability, race: Race.Special, type: Type.Unit },
    ...
    "Achd": { code: "Achd", name: "运输船保持原位(中 立敌对)", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Unit },
  ...
  const abilityItem = {
    ...
    "AIzb": { code: "AIzb", name: "带有水冻攻击伤害的物品", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    ...
    "AInd": { code: "AInd", name: "鼓舞(特别战役物品)", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    ...
    "AIft": { code: "AIft", name: "近战攻击带有冰冻伤害", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    "AIfw": { code: "AIfw", name: "近战攻击带有火焰伤害", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    "AIlx": { code: "AIlx", name: "近战攻击带有闪电伤害", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    ...
    "APh1": { code: "APh1", name: "力量上升治疗区域减小", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    "APh3": { code: "APh3", name: "力量上升治疗区域增强", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    ...
    "AIxm": { code: "AIxm", name: "能提高英雄三个属性的物品", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    "AIx3": { code: "AIx3", name: "能提高英雄属性的物品", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    "AIx4": { code: "AIx4", name: "能提高英雄属性的物品", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    ...
    "AIir": { code: "AIir", name: "能召唤水冻幽灵的物品", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    ...
    "APmg": { code: "APmg", name: "神秘区域魔法恢复增强", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
    "APra": { code: "APra", name: "神秘区域生命/魔法恢复", tip: "", kind: Kind.Ability, race: Race.Special, type: Type.Item },
  ...
  const item = {
    ...
    "lhst": { code: "", name: "风暴狮角", tip: "使得英雄和周围的单位增加<AIad,DataA1>点的护甲。|n不能和专注光环同时使用。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "ratc": { code: "", name: "攻击之爪+12", tip: "增加英雄12点的攻击力。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "rat6": { code: "", name: "攻击之爪+6", tip: "能增加英雄6点的攻击力。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "rat9": { code: "", name: "攻击之爪+9", tip: "增加英雄9点的攻击力。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "ajen": { code: "", name: "估之忍耐姜歌", tip: "增加英雄和附近单位的攻击速度和移动速度。|n不能和耐久光环同时使用。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "lgdh": { code: "", name: "毁灭之角", tip: "增加英雄和附近单位的生命值恢复速度和移动速度。|n不能和邪恶光环同时使用。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "clfm": { code: "", name: "火焰风衣", tip: "使得英雄处于火焰的包围之中，每秒对周围的地面单位造成  <AIcf,DataA1> 点的伤害。|n不能和献祭一起使用。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "kpin": { code: "", name: "卡嘉长萧", tip: "使得英雄和周围单位的魔法值恢复速度加快 。|n不能和辉煌光环同时使用。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "pmna": { code: "", name: "魔法垂饰", tip: "增加<AIbm,DataA1>点的魔法最大值。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "spsh": { code: "", name: "魔法护盾护身符", tip: "每隔<ANss,Cool1>秒就阻止敌人向自己的英雄施放魔法。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "penr": { code: "", name: "能里垂饰", tip: "增加英雄<AImb,DataA1>点的魔法最大值。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "sbch": { code: "", name: "天灾骨钟", tip: "使得近战型英雄和附近的近战型单位能将他们自己<AIav,DataA1,%>%的攻击力转换成生命值。|n不能和吸血光环同时使用。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "ward": { code: "", name: "战歌之鼓", tip: "能增加周围单位 <AIcd,DataA1,%>%的攻击力。|n不能和命令光环同时使用。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    // 可充
    "shar": { code: "", name: "水冻碎片", tip: "召唤出一个冰冻幽灵。冰冻幽灵持续<AIir,Dur1>秒。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "khno": { code: "", name: "能里之书", tip: "能提高英雄<AIlm,DataA1>个等级。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "wneg": { code: "", name: "否决权杖", tip: "能驱散一定范围内所有的魔法效果。|n可使用<wneg,uses>次。|n|cffffcc00对召唤出来的单位能造成 <AIdi,DataB1>点的伤害。|r", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "sneg": { code: "", name: "否决权杖", tip: "能驱散一定范围内所有的魔法效果。|n|cffffcc00对召唤出来的单位能造成<AIdi,DataB1>点的伤害。|r", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "mcri": { code: "", name: "机械类的小玩艺", tip: "能召唤出一个玩家所能控制的小玩艺来进行侦察。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "cnhn": { code: "", name: "赛纳留斯的号角", tip: "这个暗夜精灵族的神器据说能召唤来所有暗夜精灵的灵魂，它能赋予英雄<AIl1,DataA1>点生命值和每秒<Arel,DataA1>点的生命值恢复速度。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "dust": { code: "", name: "尘土之影", tip: "显示英雄周围的隐形单位。|n一共可以使用<dust,uses>次。|n持续<AItb,Dur1>秒。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "ram4": { code: "", name: "大魔法师指环", tip: "一件强有力的宝物，上面还装饰有碎宝石。增加英雄3点的智力，敏捷度和力量。还能加快英雄周围单位的魔法恢复速度。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "ram3": { code: "", name: "大魔法师指环", tip: "一件强有力的宝物，上面还装饰有碎宝石。增加英雄3点的智力，敏捷度和力量。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "ram2": { code: "", name: "大魔法师指环", tip: "一件强有力的宝物，上面还装饰有碎宝石。增加英雄2点的智力，敏捷度和力量。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    "ram1": { code: "", name: "大魔法师指环", tip: "一件强有力的宝物，上面还装饰有碎宝石。增加英雄1点的智力，敏捷度和力量。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "jdrn": { code: "", name: "灵巧指环", tip: "增加英雄1点的敏捷度。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "ccmd": { code: "", name: "统治权杖", tip: "能将敌方非英雄单位占为己有。这种控制权的改变而且是永久性的。|n不能被用在英雄和级别高于<AIco,DataA1>的中立单位上。|n可使用<ccmd,uses>次。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "tmsc": { code: "", name: "牺牲之书", tip: "|cff8b00ff特有的|r|n牺牲附近的一个非英雄单位来补充英雄的生命值。在装备之后也能增加英雄<AImz,DataA1>点的魔法值。", kind: Kind.Item, race: Race.Special, type: Type.Item },
    ...
    "btst": { code: "", name: "战斗标准", tip: "萨尔兽族氏族的战斗标准，骄傲地带上它吧。", kind: Kind.Item, race: Race.Special, type: Type.Item },
  ...
  const buffHuman = {
    ...
    "Bslo": { code: "", name: "减速术", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
    ...
    "Xfhl": { code: "", name: "建筑物伤害-人族 大", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
    "Xfhs": { code: "", name: "健筑物伤害-人族 小", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
    "Xfhm": { code: "", name: "建筑物伤害-人族 中", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
    "Xclf": { code: "", name: "迷雾之云(效果)", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
  ...
  const buffOrc = {
    ...
    "BOhx": { code: "", name: "妖术", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOwd": { code: "", name: "结界", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "BOvd": { code: "", name: "巫毒狂舞", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "Beng": { code: "", name: "诱捕(地面的)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bena": { code: "", name: "诱捕(空中的)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bdvv": { code: "", name: "吞噬", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bprg": { code: "", name: "净化", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Blsh": { code: "", name: "闪电之盾", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bblo": { code: "", name: "嗜血", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Beye": { code: "", name: "警戒结界", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bstt": { code: "", name: "静滞陷阱", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bsta": { code: "", name: "静滞陷阱", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bhwd": { code: "", name: "治疗结界", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Boar": { code: "", name: "治疗结界光环", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bpoi": { code: "", name: "毒素(不叠加)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bpsd": { code: "", name: "毒素(叠加)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bpsi": { code: "", name: "毒素(信息)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bakb": { code: "", name: "战鼓", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "BOwk": { code: "", name: "疾风步", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOmi": { code: "", name: "镜像", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOsf": { code: "", name: "野性之魂", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOeq": { code: "", name: "地震术", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOae": { code: "", name: "坚韧光环", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOws": { code: "", name: "战争践踏", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOea": { code: "", name: "地震术(施法者)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOsh": { code: "", name: "震荡波(施法者)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOvc": { code: "", name: "巫毒狂舞(施法者)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "BOww": { code: "", name: "剑刃风暴(施法者)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "Bdig": { code: "", name: "吞噬(施法者)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bens": { code: "", name: "诱捕(一般的)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Bliq": { code: "", name: "火油瓶", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Blsa": { code: "", name: "闪电之盾(施法者)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "XOeq": { code: "", name: "地震术(效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "XOre": { code: "", name: "重生(效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "Xbof": { code: "", name: "燃油(效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Xfos": { code: "", name: "建筑伤害 – 兽人 小", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Xfom": { code: "", name: "建筑伤害 – 兽人 中", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Xfol": { code: "", name: "建筑伤害 – 兽人 大", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "BIpb": { code: "", name: "剧毒(不叠加)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "BIpd": { code: "", name: "剧毒(叠加)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "BIpi": { code: "", name: "剧毒(信息)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
  }
  ...
  const buffNightElf = {
    ...
    "Bpsh": { code: "", name: "相位变换", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Btau": { code: "", name: "嘲讽", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "BEsh": { code: "", name: "暗影突袭", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "BEsi": { code: "", name: "暗影突袭", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "BEsv": { code: "", name: "复仇", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "Bspo": { code: "", name: "减速毒药(不叠加)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Bssd": { code: "", name: "减速毒药(叠加)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Bcor": { code: "", name: "腐蚀吐息", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "BEim": { code: "", name: "献祭", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "BEme": { code: "", name: "恶魔变形", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "BEer": { code: "", name: "纠缠根须", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "BEfn": { code: "", name: "自然之力", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "BEah": { code: "", name: "荆棘光环", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "BEst": { code: "", name: "斥候", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "BEar": { code: "", name: "强击光环", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "Bfae": { code: "", name: "精灵之火", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Bcyc": { code: "", name: "飓风术", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Bcy2": { code: "", name: "飓风术(额外的)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Brej": { code: "", name: "回春术", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Broa": { code: "", name: "咆哮", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "BEia": { code: "", name: "献祭(施法者)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "Beat": { code: "", name: "吃树", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Bgra": { code: "", name: "战棍", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Bssi": { code: "", name: "减速毒药(信息)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Bbar": { code: "", name: "树皮术", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "AEsd": { code: "", name: "星辰坠落(目标)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "AEtr": { code: "", name: "宁静(目标)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "Bult": { code: "", name: "夜视能力", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "XEsf": { code: "", name: "星辰坠落(效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "XEtq": { code: "", name: "宁静(效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "XEsn": { code: "", name: "哨兵(效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Xfns": { code: "", name: "建筑伤害 - 暗夜精灵 小", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Xfnm": { code: "", name: "建筑伤害 - 暗夜精灵 中", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Xfnl": { code: "", name: "建筑伤害 - 暗夜精灵 大", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
  }
  ...
  const buffUndead = {
    ...
    "Babr": { code: "", name: "荒芜光环", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "BUim": { code: "", name: "穿刺", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUcb": { code: "", name: "腐尸甲虫", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUlo": { code: "", name: "蝗虫", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Buns": { code: "", name: "反召唤", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bspa": { code: "", name: "小蜘蛛", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bweb": { code: "", name: "蛛网(地面)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bwea": { code: "", name: "蛛网(空中)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bapl": { code: "", name: "疾病云雾", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bfrz": { code: "", name: "冰冻吐息", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Brai": { code: "", name: "骷髅奴仆/复活死尸", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Buhf": { code: "", name: "邪恶狂热", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bams": { code: "", name: "反魔法护罩", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bam2": { code: "", name: "反魔法护罩(额外的)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bpos": { code: "", name: "占据", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "BUau": { code: "", name: "邪恶光环", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUan": { code: "", name: "亡者再临/操纵死尸", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUsl": { code: "", name: "沉睡", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUav": { code: "", name: "吸血光环", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUfa": { code: "", name: "霜甲术", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUdd": { code: "", name: "枯萎凋零", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bcrs": { code: "", name: "诅咒", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Bcri": { code: "", name: "残废术", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "BUcs": { code: "", name: "腐臭蝠群(施法者)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUsp": { code: "", name: "沉睡(暂停)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUst": { code: "", name: "沉睡(昏迷)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "BUts": { code: "", name: "尖刺甲壳", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "Bplg": { code: "", name: "疾病之云", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "BUad": { code: "", name: "亡者再临(额外的)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "Bpoc": { code: "", name: "占据(施法者)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "XUdd": { code: "", name: "枯萎凋零(效果)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "Xfus": { code: "", name: "建筑伤害 – 亡灵 小", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Xfum": { code: "", name: "建筑伤害 – 亡灵 中", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Xful": { code: "", name: "建筑伤害 – 亡灵 大", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Batp": { code: "", name: "优先攻击(1.32.9)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
  }

  const buffNeutral = {
    "BNpi": { code: "", name: "永久献祭(中立敌对1)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bpig": { code: "", name: "永久献祭(中立敌对2)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BNsl": { code: "", name: "灵魂保存", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNst": { code: "", name: "群兽奔腾", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNrf": { code: "", name: "火焰之雨(范围)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "Bfre": { code: "", name: "冰冻", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bsha": { code: "", name: "共享视野", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Btdg": { code: "", name: "龙卷风伤害", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "Btsa": { code: "", name: "龙卷风旋转(范围)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "ANmd": { code: "", name: "季风", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "XErc": { code: "", name: "混乱之雨(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "XErf": { code: "", name: "火焰之雨(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "XIct": { code: "", name: "改变一天的时间(物品)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "XNmo": { code: "", name: "季风(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNva": { code: "", name: "火山爆发(范围)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "XNvc": { code: "", name: "火山爆发(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "XNcs": { code: "", name: "集束火箭(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "XNhs": { code: "", name: "治疗喷雾(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNic": { code: "", name: "焚身化骨", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNso": { code: "", name: "灵魂燃烧", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNlm": { code: "", name: "熔岩爪牙", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNfy": { code: "", name: "口袋工厂", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNcs": { code: "", name: "集束火箭", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNeg": { code: "", name: "工程学升级", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNcg": { code: "", name: "发条地精", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNhs": { code: "", name: "治疗喷雾", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNab": { code: "", name: "酸液炸弹", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNcr": { code: "", name: "化学狂暴", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNtm": { code: "", name: "点金术", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNms": { code: "", name: "法力护盾", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNrd": { code: "", name: "火焰之雨", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BHca": { code: "", name: "寒冰箭矢", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "Bcsd": { code: "", name: "寒冰箭矢(叠加)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "Bcsi": { code: "", name: "寒冰箭矢(信息)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNht": { code: "", name: "恐惧嚎叫", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNdo": { code: "", name: "末日降临", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNdi": { code: "", name: "末日降临(奴仆)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNef": { code: "", name: "熊猫人元素之灵", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNsg": { code: "", name: "巨熊", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNsq": { code: "", name: "豪猪", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNsw": { code: "", name: "战鹰", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNmr": { code: "", name: "心智腐烂", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNbf": { code: "", name: "火焰之息", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNdh": { code: "", name: "酩酊酒雾", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNsi": { code: "", name: "沉默", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNba": { code: "", name: "黑蚀箭", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNdm": { code: "", name: "黑暗奴仆", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BNmo": { code: "", name: "季风", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNwm": { code: "", name: "水栖奴仆", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Basl": { code: "", name: "龙卷风(减速光环)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "Btsp": { code: "", name: "龙卷风旋转(自动施放飓风)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNto": { code: "", name: "龙卷风(时间化生命)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNdc": { code: "", name: "黑暗转换", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BNsp": { code: "", name: "灵魂保存", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bchd": { code: "", name: "眩晕", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BNin": { code: "", name: "地狱火", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bfzy": { code: "", name: "狂乱", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Boac": { code: "", name: "统御光环", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BTLF": { code: "", name: "限时生命", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Barm": { code: "", name: "法力恢复光环", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BCbf": { code: "", name: "冰霜吐息", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BCtc": { code: "", name: "砸击", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BNbr": { code: "", name: "战斗咆哮", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BNpm": { code: "", name: "寄生虫", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BNpa": { code: "", name: "寄生虫", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bdet": { code: "", name: "被侦测到", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bvul": { code: "", name: "无敌", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bspe": { code: "", name: "速度加成", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Bfro": { code: "", name: "减速", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BSTN": { code: "", name: "昏迷", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "BPSE": { code: "", name: "昏迷(暂停)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Xbli": { code: "", name: "荒芜(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Xbdt": { code: "", name: "暴露(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
    "Xdis": { code: "", name: "英雄消散(效果)", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Hero },
    "BNhe": { code: "", name: "中立治疗术", tip: "", kind: Kind.Buff, race: Race.Neutral, type: Type.Unit },
  }
