...
const unitHuman:Format = {
  ...
  const buffHuman:Format = {
    ...
    "XHbz": { code: "", name: "暴风雪(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Hero },
    "XHfs": { code: "", name: "烈焰风暴(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Hero },
    "Xclf": { code: "", name: "迷雾之云(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
    "Xfla": { code: "", name: "照明弹 (效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
    "Xfhl": { code: "", name: "建筑物伤害-人族 大(区域效果)", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
    "Xfhs": { code: "", name: "健筑物伤害-人族 小(区域效果)", tip: "", kind: Kind.Buff, race: Race.Human, type: Type.Unit },
  ...
  const buffOrc:Format = {
    ...
    "XOeq": { code: "", name: "地震术(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "XOre": { code: "", name: "重生(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Hero },
    "Xbof": { code: "", name: "燃油(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Xfos": { code: "", name: "建筑伤害 – 兽人 小(区域效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
    "Xfom": { code: "", name: "建筑伤害 – 兽人 中(区域效果)", tip: "", kind: Kind.Buff, race: Race.Orc, type: Type.Unit },
  ...
  const buffNightElf:Format = {
    ...
    "XEsf": { code: "", name: "星辰坠落(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "XEtq": { code: "", name: "宁静(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Hero },
    "XEsn": { code: "", name: "哨兵(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Xfns": { code: "", name: "建筑伤害 - 暗夜精灵 小(区域效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
    "Xfnm": { code: "", name: "建筑伤害 - 暗夜精灵 中(区域效果)", tip: "", kind: Kind.Buff, race: Race.NightElf, type: Type.Unit },
  ...
  const buffUndead:Format = {
    ...
    "XUdd": { code: "", name: "枯萎凋零(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Hero },
    "Xfus": { code: "", name: "建筑伤害 – 亡灵 小(区域效果)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
    "Xfum": { code: "", name: "建筑伤害 – 亡灵 中(区域效果)", tip: "", kind: Kind.Buff, race: Race.Undead, type: Type.Unit },
  ...
  const buffSpecial:Format = {
    ...
    "BNsl": { code: "", name: "灵魂保存", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNst": { code: "", name: "群兽奔腾", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNrf": { code: "", name: "火焰之雨(范围)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "Bfre": { code: "", name: "冰冻", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Bsha": { code: "", name: "共享视野", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Btdg": { code: "", name: "龙卷风伤害", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "Btsa": { code: "", name: "龙卷风旋转(范围)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "ANmd": { code: "", name: "季风", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNva": { code: "", name: "火山爆发(范围)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNic": { code: "", name: "焚身化骨", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNso": { code: "", name: "灵魂燃烧", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNlm": { code: "", name: "熔岩爪牙", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNfy": { code: "", name: "口袋工厂", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNcs": { code: "", name: "集束火箭", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNeg": { code: "", name: "工程学升级", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNcg": { code: "", name: "发条地精", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNhs": { code: "", name: "治疗喷雾", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNab": { code: "", name: "酸液炸弹", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNcr": { code: "", name: "化学狂暴", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNtm": { code: "", name: "点金术", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNms": { code: "", name: "法力护盾", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNrd": { code: "", name: "火焰之雨", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BHca": { code: "", name: "寒冰箭矢", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "Bcsd": { code: "", name: "寒冰箭矢(叠加)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "Bcsi": { code: "", name: "寒冰箭矢(信息)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNht": { code: "", name: "恐惧嚎叫", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNdo": { code: "", name: "末日降临", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNdi": { code: "", name: "末日降临(奴仆)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNef": { code: "", name: "熊猫人元素之灵", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNsg": { code: "", name: "巨熊", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNsq": { code: "", name: "豪猪", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNsw": { code: "", name: "战鹰", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNmr": { code: "", name: "心智腐烂", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNbf": { code: "", name: "火焰之息", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNdh": { code: "", name: "酩酊酒雾", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNsi": { code: "", name: "沉默", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNba": { code: "", name: "黑蚀箭", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNdm": { code: "", name: "黑暗奴仆", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "BNmo": { code: "", name: "季风", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNwm": { code: "", name: "水栖奴仆", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Basl": { code: "", name: "龙卷风(减速光环)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "Btsp": { code: "", name: "龙卷风旋转(自动施放飓风)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNto": { code: "", name: "龙卷风(时间化生命)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "BNdc": { code: "", name: "黑暗转换", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "BNsp": { code: "", name: "灵魂保存", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Bchd": { code: "", name: "眩晕", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "BNin": { code: "", name: "地狱火", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Bfzy": { code: "", name: "狂乱", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Boac": { code: "", name: "统御光环", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "BTLF": { code: "", name: "限时生命", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Barm": { code: "", name: "法力恢复光环", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "BCbf": { code: "", name: "冰霜吐息", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "BCtc": { code: "", name: "砸击", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    ...
    "BSTN": { code: "", name: "昏迷", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "BPSE": { code: "", name: "昏迷(暂停)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Xbli": { code: "", name: "荒芜(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Xbdt": { code: "", name: "暴露(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "Xdis": { code: "", name: "英雄消散(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "XErc": { code: "", name: "混乱之雨(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "XErf": { code: "", name: "火焰之雨(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "XIct": { code: "", name: "改变一天的时间(物品)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Unit },
    "XNmo": { code: "", name: "季风(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "XNvc": { code: "", name: "火山爆发(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
    "XNcs": { code: "", name: "集束火箭(效果)(区域效果)", tip: "", kind: Kind.Buff, race: Race.Special, type: Type.Hero },
