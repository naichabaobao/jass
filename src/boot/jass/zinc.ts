import { Document } from "./tokenizer-common";

export function parse_zinc(document:Document) {
    // const macros:Macro[] = [];
    ...
    for (let index = 0; index < document.lineCount; index++) {
        ...
        const run_text_macro_index = document.line_run_text_macro_indexs[index];
        if (macro_index.is_macro) {
