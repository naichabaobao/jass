...
- [x] 按文件管理宏
- [x] 统计信息功能
- [x] 文件路径：`src/boot/vjass/text-macro-registry.ts`
...
- [x] 参数验证
- [x] 自动注册到注册表
- [x] 文件路径：`src/boot/vjass/text-macro-collector.ts`
...
- [x] 可选宏支持
- [x] 错误处理
- [x] 文件路径：`src/boot/vjass/text-macro-expander.ts`
...
- [x] 文件删除时移除注册表
- [x] 文件重命名时更新路径
- [x] 文件路径：`src/boot/provider-new/data-enter.ts`
...
- [x] 展开后的代码解析
- [x] 错误合并
- [x] 文件路径：`src/boot/vjass/parser.ts`

### 6. AST 节点✅
- [x] TextMacroStatement 类
- [x] RunTextMacroStatement 类
- [x] 导出到 vjass-ast.ts
- [x] 文件路径：`src/boot/vjass/vjass-ast.ts`

### 7. 词法解析器✅
- [x] 识别 //! 为 TextMacroDirective
- [x] 文件路径：`src/boot/vjass/lexer.ts`
...
参考 `src/boot/vjass/text-macro-test.ts` 中的测试用例。
