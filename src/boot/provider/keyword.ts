...
const ZincKeywords = [...Keywords, "for", "while", "library", "interface", "static", "method", "debug", "debug", "break", "operator", "module", "optional", "delegate", "private", "public", "requires"]

const AllKeywords = [...Keywords, ...VjassKeywords];
