...
//   ["imagetype", "图像类型"],
//   ["ubersplat", "地表纹理变化"],
//   ["ubersplattype", "地表纹理类型"],
//   ["hashtable", "哈希表"],
//   ["framehandle", "UI框架/控件句柄"],
//   ["originframetype", "原生 UI框架/控件句柄 类型"],
//   ["framepointtype", "UI框架/控件句柄 相对锚点类型"],
//   ["textaligntype", "文本对齐方式"],
//   ["frameeventtype", "UI框架/控件句柄 事件类型"],
//   ["oskeytype", "键盘按键类型"],
...
//   ["abilitystringlevelfield", "技能随等级改变的字符串域"],
...
//   ["abilitystringlevelarrayfield", "技能随等级改变的字符串数组域"],
...
// // 1.32
//   ["minimapicon", "小地图（任务）图标/小地图标记（不同于中立建筑的小地图特殊图标）"],
