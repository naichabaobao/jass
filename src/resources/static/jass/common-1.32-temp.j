...
//===================================================
    ...
    constant placement          MAP_PLACEMENT_USE_MAP_SETTINGS      = ConvertPlacement(2)   // // values allow the action code to determine which
  event was specified by the script
...
//===================================================
 ...
 constant playerunitevent EVENT_PLAYER_UNIT_SPELL_ENDCAST         = ConvertPlayerUnitEvent(276)
    ...
    // variable, // Limit Event API constants    
