...
// 设置地形迷雾 
// @param style 风格，输入0,1,2[对应线性，指数，指数2，高度，新指数，新指数2]
// @param zstart Z 轴初始值
// @param zend Z 轴结束值
// @param density 密度
...
// 获取指定单位的装备槽是否拥有指定装备类型的物品
// 查到第一个同类型装备就返回该装备槽数，没有返回0
// @since 3.0
