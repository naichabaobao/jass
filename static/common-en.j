...
// Reference-counted objects/agents
type agent extends handle // all reference counted objects
// Event
type event extends agent // a reference to an event registration
// Player
type player extends agent // a single player reference
// Widget (any living interactive game object with life, e.g., units, items, destructibles)
...
// Igamestate (Integer game state)
type igamestate extends gamestate
// Fgamestate (Floating-point game state)
...
// Gamedifficulty (Used for campaigns, set before starting a campaign or after mission failure)
type gamedifficulty extends handle
// Gametype (Game (team) type)
type gametype extends handle
// Mapflag (Map parameters - some initial values come from room's player settings and advanced options)
...
// Mapcontrol (Player controller type)
type mapcontrol extends handle
// Minimapicon (Minimap (quest) icon)
...
// Playercolor (12 types for 1.28 and below, 24 for 1.29 and above, excluding neutral player colors)
type playercolor extends handle
// Placement (Starting location placement method)
type placement extends handle
// Startlocprio (Starting location distribution priority)
...
// Version (Reign of Chaos or The Frozen Throne)
...
// Framehandle (UI framework/control handle)
type framehandle extends handle
// Originframetype (Native UI framework/control handle type)
type originframetype extends handle
// UI framework/control handle relative anchor type
type framepointtype extends handle
// Text alignment type
type frameeventtype extends handle
// UI framework/control handle event type
...
// Convert command ID to command string
constant native OrderId2String takes integer orderId returns string
// Convert unit type string to unit type
constant native UnitId takes string unitIdString returns integer
// Convert unit type to unit type string
constant native UnitId2String takes integer unitId returns string

// Convert ability ID string to ability ID, currently not working correctly
constant native AbilityId takes string abilityIdString returns integer
// Convert ability ID to ability ID string
...
globals
	...
	// Camera margin - Left, seems to be a constant value of 512
	constant integer CAMERA_MARGIN_LEFT = 0
	// Camera margin - Right, seems to be a constant value of 512
	constant integer CAMERA_MARGIN_RIGHT = 1
	// Camera margin - Top, seems to be a constant value of 256
	constant integer CAMERA_MARGIN_TOP = 2
	// Camera margin - Bottom, seems to be a constant value of 256
	constant integer CAMERA_MARGIN_BOTTOM = 3
	
	
	// Effect API constants
	
	// Effect type - Point target effect
	...
	// Effect type - Caster effect
	constant effecttype EFFECT_TYPE_CASTER = ConvertEffectType(2)
	// Effect type - Special effect
	constant effecttype EFFECT_TYPE_SPECIAL = ConvertEffectType(3)
	// Effect type - Area effect
	constant effecttype EFFECT_TYPE_AREA_EFFECT = ConvertEffectType(4)
	// Effect type - Missile/projectile effect
	constant effecttype EFFECT_TYPE_MISSILE = ConvertEffectType(5)
	// Effect type - Lightning effect
	constant effecttype EFFECT_TYPE_LIGHTNING = ConvertEffectType(6)
	// Sound type - Effect
	constant soundtype SOUND_TYPE_EFFECT = ConvertSoundType(0)
	// Sound type - Looped effect
	constant soundtype SOUND_TYPE_EFFECT_LOOPED = ConvertSoundType(1)
	
	
	// Custom UI API constants
	
	// Native UI framework/control handle type - Game UI (required, without it, nothing is displayed)
	constant originframetype ORIGIN_FRAME_GAME_UI = ConvertOriginFrameType(0)
	// Native UI framework/control handle type - Command button (includes Move/Stop/Patrol/Attack, total 12 grids)
	// It will reappear/update every time a unit is selected
	constant originframetype ORIGIN_FRAME_COMMAND_BUTTON = ConvertOriginFrameType(1)
	// Native UI framework/control handle type - Hero bar (F1, F2 button corresponding hero avatar area)
	// Parent of all HERO_BUTTONS, controlled by HeroButtons visibility
	constant originframetype ORIGIN_FRAME_HERO_BAR = ConvertOriginFrameType(2)
	// Native UI framework/control handle type - Hero avatar (F1, F2... left side of the screen's own/shared control ally hero avatar button)
	constant originframetype ORIGIN_FRAME_HERO_BUTTON = ConvertOriginFrameType(3)
	// Native UI framework/control handle type - HP bar below hero avatar, associated with HeroButtons
	constant originframetype ORIGIN_FRAME_HERO_HP_BAR = ConvertOriginFrameType(4)
	// Native UI framework/control handle type - Mana bar below hero avatar, associated with HeroButtons
...
// Originframetype (Native UI framework/control handle type)
type originframetype extends handle
// Framepointtype (UI framework/control handle relative anchor type)
type framepointtype extends handle
// Textaligntype
type textaligntype extends handle
// Frameeventtype (UI framework/control handle event type)
type frameeventtype extends handle
// Oskeytype
type oskeytype extends handle
// Abilityintegerfield
...
globals
	...
	// 动画类型 - 施法
	constant animtype ANIM_TYPE_SPELL = ConvertAnimType(9)
	// Animation type - Portrait window
	constant animtype ANIM_TYPE_PORTRAIT = ConvertAnimType(10)
	// Sub-animation type - Rooted
	constant subanimtype SUBANIM_TYPE_ROOTED = ConvertSubAnimType(11)
	// Sub-animation type - Alternate Ex
...
// Get ability integer level field
...
// Get ability string level field
...
// Get ability boolean level array field
...
// Get ability integer level array field
...
// Get ability real level array field
...
// Get ability string level array field
...
// Set ability string level field
...
// Set ability boolean level array field
...
// Set ability integer level array field
...
// Set ability real level array field
...
// Set ability string level array field
...
// Add ability boolean level array field
...
// Add ability integer level array field
...
// Add ability real level array field
...
// Add ability string level array field
...
// Remove ability boolean level array field
...
// Remove ability integer level array field
...
// Remove ability real level array field
...
// Remove ability string level array field
