    ...
    // 技能命令ID 取消修理(人族、兽族、娜迦族、达拉内尔族(破碎者))
    ...
    // 技能命令ID 空投坦克(tankdroppilot)
    constant integer 852079
    // 技能命令ID 挂载坦克(tankloadpilot)
    constant integer 852080
    // 技能命令ID 挂载坦克形态(tankpilot)
