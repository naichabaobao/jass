...
**文件**: `src/vjass/text-macro-registry.ts`
...
**文件**: `src/vjass/text-macro-collector.ts`
...
**文件**: `src/vjass/text-macro-expander.ts`
...
**文件**: `src/provider/data-enter-manager.ts`
...
创建了 `src/vjass/text-macro-test.ts` 用于测试。
